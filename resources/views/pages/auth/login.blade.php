        ...
        <section class="section">
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        <img src="{{ asset('img/one.png') }}" alt="logo" width="70"
                            class="shadow-light  mb-5 mt-2">
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Vote
                                2024</span>
                        </h4>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Silent Team. Made with 💙 by Ellypsis
                        </div>
                    </div>
                </div>
